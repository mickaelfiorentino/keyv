...
#define Start_Timer()   Begin_Time = get_keyv_time()
#define Stop_Timer()    End_Time   = get_keyv_time()
#define Start_Inst()    Begin_Inst = get_keyv_insn()
#define Stop_Inst()     End_Inst   = get_keyv_insn()
#define NUMBER_OF_RUNS	1 // 500 
